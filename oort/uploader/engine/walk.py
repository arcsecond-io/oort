...
if __name__ == '__main__':
    ...
    username, upload_key, subdomain, role, telescope, longitude, debug_str = sys.argv[2].split(",")
    debug = (debug_str == 'True')
    identity = Identity(username, upload_key, subdomain, role, telescope, longitude, debug)
