...
class UploadsLocalState(State):
    def __init__(self, config):
        ...
        self.context.payload.group_update('state', **self.context.to_dict())
        self.context.payload.group_update('state', showTables=False)
        self.context.payload.update(current_uploads=[], finished_uploads=[])
    ...
    def sync_calibrations_uploads(self):
        ...
        self.context.payload.group_update('state', showTables=True)
