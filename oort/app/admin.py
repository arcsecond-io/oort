...
#
# from .helpers import RootFolder, LocalState
#
#
...
#         #     print(f'Found telescopes: {self.walker.telescopes}')
#
...
#
#         # if self.context.debug:
#         #     print(f'Validated telescopes: {valid_telescopes}')
...
#
#         # if self.context.debug:
#         #     print(f'Validated night logs: {local_logs}')
