...
def test_observer_empty():
    with patch.object(PathObserverManager, 'schedule', return_value={}) as mocked_method_schedule, \
            patch.object(PathObserverManager, '_start_initial_walk', return_value={}) as mocked_method_walk, \
            patch.object(threading.Thread, 'start'), \
            patch.object(threading.Timer, 'start'):
        po = PathObserverManager()
